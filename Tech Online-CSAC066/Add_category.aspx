...
<p style="margin-left: 200px">
    <asp:Button ID="add_category" runat="server" Text="Add" BackColor="#0033CC" BorderColor="Yellow" BorderStyle="Solid" Font-Bold="True" Font-Size="Medium" ForeColor="Yellow" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="edit_category" runat="server" Text="Edit" BackColor="#0033CC" BorderColor="Yellow" BorderStyle="Solid" Font-Bold="True" Font-Size="Medium" ForeColor="Yellow" PostBackUrl="~/edit_category.aspx"/>
    </p>
